...
<h3 class="f12px cgray fn lh20px bline">
	<span class="cred fl indent10px f14px"><b>蛋糕商品搜索：</b>为您找到&nbsp;<span id="shop-nums"><?php echo $goodscount;?></span>&nbsp;个商品</span>
	<div class="clear"></div>
</h3>
<?php foreach ((array)$goods as $sn => $v):?>
<div class="f14px cblack m10px lh30px indent10px shop-search">
	<div class="fl fb"><?php echo $v[0]->shop->getNameLinkHtml(0, '_blank');?></div>
...
<div class="goods-list m10px">
 	...
 	<?php foreach ($v as $k=>$g):?>
    	<li class="pa-10px lhnormal goods-item clr li-bg<?php echo $k%2;?>" gid="<?php echo $g->id;?>">
		    <div class="fl shop-desc cblack"><?php echo $g->fullName;?><br /><span class="cgray"><?php echo $g->goodsModel->buy_advice;?></span></div>
