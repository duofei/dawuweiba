	...
	<div class="c-right-content">
		<div class="miaosha-info pa-t20px cgray">
			<div style="width:450px; margin:0px auto;">
				...
				<?php if($sendtype==2):?>
					　　<span id="showMsg">电话号码 <span class="cred">+86 <?php echo $telphone;?></span> 已经向此号发送语音验证码。</span>
				<?php else: ?>
				...
				<div class="ac lh24px"><input type="button" id="btnId" value="(120秒后) 使用语音获取" class="pa-l5px pa-r5px" disabled='disabled' /> 或 <span class="cred"><a href="<?php echo url('miaosha2/order', array('miaosha_id'=>$miaosha_id));?>">返回修改手机</a></span></div>
			</div>
		</div>
	</div>
