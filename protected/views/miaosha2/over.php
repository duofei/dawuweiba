	...
	<div class="c-right-content">
		<div class="miaosha-info">
			...
			<div class="fl ma-t30px ma-l30px">
				<?php if((time()+86400) > $miaoshaEndTime):?>
				<div class="ma-l20px ma-t20px">
					<a href="http://weibo.com/my52wm" target="_blank"><?php echo CHtml::image(resBu('miaosha2/images/overmsg.jpg'));?></a>
				</div>
			...
			<div class="ma-t20px ac"><a href="<?php echo url('my/default/inviteurl');?>" target="_blank"><?php echo CHtml::image(resBu('miaosha2/images/js__r9_c2.gif'));?></a></div>
		</div>
	</div>
