 <?php echo CHtml::beginForm(url('super/searchlog/search'),'get',array('name'=>'edit'));?>
<table  class="tabcolor list-tbl ma-b5px" width="100%" cellspacing="1">
    <tr>
        <td width="120" class="ar">关键字：</td>
        <td width="300"><?php echo CHtml::textField('Search[keywords]', $search['keywords'], array('class'=>'txt')); ?></td>        
...
?></td>       
    ...
    <tr>
        ...
        <td colspan="3"><?php echo CHtml::radioButtonList('Search[city_id]', $search['city_id']?$search['city_id']:1, $citylist, array('separator'=>''))?></td>
    </tr>
</table>
