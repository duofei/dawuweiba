<div id="start-page">
	...
	<ul>
		<li class="fb">订单信息</li>
		<li>今日订单量：<?php echo Order::getCountOfToday();?>单</li>
		<li>今日订单总额：<?php echo Order::getAmountOfToday();?>元</li>
		<li>最近7天订单量：<?php echo Order::getCountOfDays(7);?>单</li>
		<li>最近7天订单总额：<?php echo Order::getAmountOfDays(7);?>元</li>
		<li>最近1个月订单量：<?php echo Order::getCountOfDays(30);?>单</li>
		<li>最近1个月订单总额：<?php echo Order::getAmountOfDays(30);?>元</li>
		<li>总订单量：<?php echo Order::getCountOfCity();?>单</li>
		<li>总订单额：<?php echo Order::getAmountOfCity();?>元</li>
	</ul>
	<div class="space10pxline"></div>
	<ul>
		<li class="fb">店铺信息</li>
		<li>餐馆数量：<?php echo Shop::getFoodShopCount();?>家</li>
		<li>蛋糕店数量：<?php echo Shop::getCakeShopCount();?>家</li>
	</ul>
	<div class="space10pxline"></div>
	<ul>
		<li class="fb">用户信息</li>
