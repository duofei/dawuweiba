<div class="right-nav">
    <ul class="nav">
	  <li class="select corner-top cgray"><a href="<?php echo url("my/question/list");?>">已回复留言</a></li>
	  <li class="normal corner-top cgray"><a href="<?php echo url("my/question/alllist");?>">全部留言</a></li>
	</ul>
</div>
