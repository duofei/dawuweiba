<div id="yw0" class="ui-tabs ui-widget ui-widget-content ui-corner-all">
    ...
    <ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header">
	  <li class="ui-state-default ui-corner-top ui-tabs-selected ui-state-active"><a href="<?php echo url("shopcp/question/noreply");?>">未回复留言</a></li>
	...
	<?php if ($noreply) :?>
    <?php foreach ($noreply as $key=>$val):?>
    <div>
        <span class="ma-r20px">用户：<?php echo $val->user->username;?></span>
        <?php if ($val->order):?>订单号：<span class="ma-r20px"><?php echo $val->order->orderSn?></span><?php endif;?>   
        <span class="fr ma-r10px"><a href="<?php echo url('shopcp/question/reply', array('qid'=>$val->id))?>"><span class="f14px color">回复留言</span></a></span><br />  
	</div>
