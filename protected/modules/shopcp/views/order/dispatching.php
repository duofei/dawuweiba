<div id="yw0" class="ui-tabs ui-widget ui-widget-content ui-corner-all">
    <ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header">
	  ...
	  <li class="ui-state-default ui-corner-top ui-tabs-selected ui-state-active"><a href="<?php echo url("shopcp/order/dispatching");?>">配送中订单</a></li>
...
<table  class="tabcolor list-tbl ma-b5px" width="100%">
    <tr class="title">
        ...
        <th class="al" width="100">电话号码</th>
        <th class="al">送餐地址</th>
        <th class="al" width="60">订单总价</th>
        <th class="al" width="60">实收金额</th>
        <th class="al" width="60">配送员</th>
  ...
  <table class="list-tbl bline order-title" width="100%">
	  <tr>
	    ...
	    <td width="100"><?php echo h($val->telphone)?></td>
	    ...
	    <td width="60">&yen;<?php echo CHtml::textField('actual_money', $val->amountPrice, array('class'=>'txt', 'style'=>'width:40px'))?></td>
	    <td width="60"><?php echo $val->deliveryMan->name?></td>
	    <td width="40"><a href="<?php echo url('shopcp/order/state', array(type=>Order::STATUS_COMPLETE, id=>$val->id));?>" class="submit-man"><span class="color">核算</span></a></td>
	  </tr>
 </table>
...
$(function() {
	...
	$("a.submit-man").click(function(e){
		var actual_money = $(this).parent().siblings().find('input[name="actual_money"]').val();
		var url = $(this).attr('href') + '?actual_money=' + actual_money;
		$(this).attr('href', url);
	});
});
