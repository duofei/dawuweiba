<div id="yw0" class="ui-tabs ui-widget ui-widget-content ui-corner-all">
    <ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header">
	  <li class="ui-state-default ui-corner-top ui-tabs-selected ui-state-active"><a href="<?php echo url("shopcp/orderprinter/finish");?>">已完成订单</a></li>
	  ...
	  <li class="ui-state-default ui-corner-top"><a href="<?php echo url("shopcp/orderprinter/list");?>">全部订单</a></li>
	</ul>
    <div id="index" class="ui-tabs-panel">
 <?php echo CHtml::beginForm(url('shopcp/orderprinter/state'),'post',array('name'=>'edit'));?>
 <?php if ($order) :?>
<table  class="tabcolor list-tbl ma-b5px" width="100%">
  ...
  <table class="list-tbl bline order-title" width="100%">
	  <tr>
	    ...
	    <td width="60" class="cred">
	    	<?php echo l('申请取消', url('shopcp/orderprinter/cancelorder', array('id'=>$val->id)), array('onclick'=>"return confirm('确定要取消此订单吗？')"));?>
	    </td>
	  </tr>
 </table>
