...
/**
 * This is the model class for table "{{OpenSuggest}}".
 *
 * The followings are the available columns in table '{{OpenSuggest}}':
 * @property integer $id
 ...
 */
class OpenSuggest extends CActiveRecord
{
    
	/**
	 * Returns the static model of the specified AR class.
	 * @return OpenSuggest the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('province, city, email', 'required'),
			array('create_time', 'numerical', 'integerOnly'=>true),
			array('create_ip', 'length', 'max'=>15, 'min'=>7),
			array('email, city, province', 'length', 'max'=>255),
			array('email', 'email'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, province, city, email, create_time, create_ip', 'safe', 'on'=>'search'),
		);
	}
	/**
	...
	public function search()
	{
		...
		return new CActiveDataProvider('OpenSuggest', array(
			'criteria'=>$criteria,
		));
	}
