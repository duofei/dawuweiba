 ...
 *
 * The followings are the available columns in table '{{AdminLog}}':
 * @property integer $id
...
class AdminLog extends CActiveRecord
{
	 ...
	 * @return object AdminLog对象
	 */
	public static function saveManageLog($content)
	{
		$log = new self();
		$log->user_id = $_SESSION['manage_city_id'];
		$log->content = $content;
		$log->save();
		return $log;
	}
