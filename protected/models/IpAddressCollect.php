...
/**
 * This is the model class for table "{{IpAddressCollect}}".
 *
 * The followings are the available columns in table '{{IpAddressCollect}}':
 * @property integer $id
 * @property string $create_ip
 * @property integer $create_time
 */
class IpAddressCollect extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return IpAddressCollect the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, create_ip, create_time', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		return new CActiveDataProvider('IpAddressCollect', array(
			'criteria'=>$criteria,
		));
	}
