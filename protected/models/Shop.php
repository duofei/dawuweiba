...
class Shop extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('user_id, category_id, district_id, is_voucher, create_time, update_time, order_nums, visit_nums, favorite_nums, comment_nums, taste_mark_nums, taste_mark, service_mark_nums, service_mark, business_state, is_group, is_muslim, is_bcshop, is_sanitary_approve, is_commercial_approve, is_dailymenu, undressed_order_nums, goods_nums, buy_type, pay_type, coupon_nums, update_time, state, yewu_id, printer_no', 'numerical', 'integerOnly'=>true),
	...
	public function search()
	{
		...
		$criteria->compare('is_voucher',$this->is_voucher);
	...
	{
	    if (STATE_ENABLED != $this->is_voucher) return null;
	    return CHtml::image(resBu('images/pixel.gif'),
	        '该店铺支持优惠券',
	        array(
	            'title' => '该店铺支持优惠券',
	            'class' => 'bg-icon is-voucher'
	        )
	    );
	}
