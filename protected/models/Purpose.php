...
class Purpose extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'CakeGoods' => array(self::MANY_MANY, 'CakeGoods', '{{CakePurpose}}(purpose_id, goods_id)'),
		);
	}
	...
	public function search()
	{
		...
		return new CActiveDataProvider('Purpose', array(
			'criteria'=>$criteria,
		));
	}
	 ...
	 * 获取用途key=>value形式的数组
	 */
	public static function getPurposeArray()
	{
		$array = array();
